...
export const NavbarAdmin = () => {
  ...
  return (
    <div className="bg-base-200 h-full text-base-content p-2 relative">
      ...
      <div className="absolute bottom-0 w-full p-2 left-0">
        ...
        <div className="flex gap-3 items-center text-sm">
            <img src={authUser.profilePic || "/assets/logo.png"} alt="" className="size-10" />
            <div className="flex flex-col">
                <p className="font-medium text-base-content">{authUser.name}</p>
                <p>{authUser.email}</p>
            </div>
            <button onClick={logout} className="p-2 rounded-md bg-base-content text-base-100 cursor-pointer hover:bg-base-300 hover:text-base-content transition-all">
                <LogOut/>
            </button>
        </div>
      </div>
